...
export const STAPLE_CARDS: CatalogItem[] = [
  ...
  { name: "Number 41: Bagooska the Terribly Tired Tapir", rating: "S", price: 200, imageUrl: getCardImageUrl(90590303) },
  { name: "Linkuriboh", rating: "A", price: 100, imageUrl: getCardImageUrl(41999284) },
  { name: "Secure Gardna", rating: "A", price: 100, imageUrl: getCardImageUrl(11044972) },
  { name: "Mudragon of the Swamp", rating: "A", price: 100, imageUrl: getCardImageUrl(75937826) },
  { name: "Starving Venom Fusion Dragon", rating: "A", price: 100, imageUrl: getCardImageUrl(85682655) },
  
  // Generic Main Deck
  { name: "Mind Control", rating: "A", price: 100, imageUrl: getCardImageUrl(37520316) },
  { name: "Honest", rating: "B", price: 50, imageUrl: getCardImageUrl(37742478) },
  { name: "Ghost Reaper & Winter Cherries", rating: "S", price: 200, imageUrl: getCardImageUrl(62015408) },
  { name: "Imperial Order", rating: "S+", price: 400, imageUrl: getCardImageUrl(61740673) },
  { name: "Vanity's Emptiness", rating: "S", price: 200, imageUrl: getCardImageUrl(5851097) },
  { name: "Mistake", rating: "A", price: 100, imageUrl: getCardImageUrl(58481572) },
  { name: "Thunder King Rai-Oh", rating: "A", price: 100, imageUrl: getCardImageUrl(71564252) },
  { name: "Scapegoat", rating: "B", price: 50, imageUrl: getCardImageUrl(73915051) },
  { name: "System Down", rating: "A", price: 100, imageUrl: getCardImageUrl(18895832) },
  { name: "Token Collector", rating: "A", price: 100, imageUrl: getCardImageUrl(95466842) },
  { name: "Gnomaterial", rating: "A", price: 100, imageUrl: getCardImageUrl(46652477) },
  
  // Additional Staples
  { name: "Mystical Space Typhoon", rating: "B", price: 50, imageUrl: getCardImageUrl(5318639) },
  { name: "Torrential Tribute", rating: "A", price: 100, imageUrl: getCardImageUrl(53582587) },
  { name: "Bottomless Trap Hole", rating: "A", price: 100, imageUrl: getCardImageUrl(29401950) },
  { name: "Compulsory Evacuation Device", rating: "A", price: 100, imageUrl: getCardImageUrl(94192409) },
  { name: "Dimensional Prison", rating: "B", price: 50, imageUrl: getCardImageUrl(70342110) },
  { name: "Mirror Force", rating: "B", price: 50, imageUrl: getCardImageUrl(44095762) },
  { name: "Storming Mirror Force", rating: "B", price: 50, imageUrl: getCardImageUrl(29771507) },
  { name: "Drowning Mirror Force", rating: "B", price: 50, imageUrl: getCardImageUrl(47475363) },
  { name: "Quaking Mirror Force", rating: "B", price: 50, imageUrl: getCardImageUrl(40838625) },
  { name: "Blazing Mirror Force", rating: "B", price: 50, imageUrl: getCardImageUrl(27134209) },
  ...
  { name: "Retaliating \"C\"", rating: "B", price: 50, imageUrl: getCardImageUrl(84268896) },
  { name: "Flying \"C\"", rating: "B", price: 50, imageUrl: getCardImageUrl(17016362) },
  { name: "Psy-Frame Driver", rating: "B", price: 50, imageUrl: getCardImageUrl(68304193) },
  { name: "Herald of Orange Light", rating: "B", price: 50, imageUrl: getCardImageUrl(17266660) },
  { name: "Herald of Purple Light", rating: "B", price: 50, imageUrl: getCardImageUrl(22858242) },
  { name: "Honest", rating: "B", price: 50, imageUrl: getCardImageUrl(37742478) },
  ...
  { name: "Chaos Emperor Dragon - Envoy of the End", rating: "S", price: 200, imageUrl: getCardImageUrl(82301904) },
  { name: "Black Luster Soldier - Envoy of the Beginning", rating: "S", price: 200, imageUrl: getCardImageUrl(72989439) },
  { name: "Dark Armed Dragon", rating: "A", price: 100, imageUrl: getCardImageUrl(65192027) },
  { name: "Judgment Dragon", rating: "S", price: 200, imageUrl: getCardImageUrl(22624373) },
  { name: "Card of Demise", rating: "A", price: 100, imageUrl: getCardImageUrl(59750328) },
  { name: "Into the Void", rating: "B", price: 50, imageUrl: getCardImageUrl(14778250) },
  { name: "Magical Meltdown", rating: "A", price: 100, imageUrl: getCardImageUrl(47679935) },
  { name: "Spellbook of Knowledge", rating: "A", price: 100, imageUrl: getCardImageUrl(23314220) },
  { name: "The Monarchs Stormforth", rating: "A", price: 100, imageUrl: getCardImageUrl(79844764) },
  { name: "Soul Charge", rating: "S", price: 200, imageUrl: getCardImageUrl(67227834) },
  { name: "Return of the Dragon Lords", rating: "B", price: 50, imageUrl: getCardImageUrl(6172122) },
];
