...
export class DataStoreClient {
  ...
  private async request<T>(endpoint: string, data: unknown): Promise<T> {
    ...
    switch (endpoint) {
      ...
      case "/data/store/v1/insert":
        return (await sup.insert(data as any)) as unknown as T;
      case "/data/store/v1/purge":
        return (await sup.purge(data as any)) as unknown as T;
      case "/data/store/v1/get":
        return (await sup.get(data as any)) as unknown as T;
      case "/data/store/v1/set":
        return (await sup.set(data as any)) as unknown as T;
      case "/data/store/v1/delete":
        return (await sup.delete(data as any)) as unknown as T;
      case "/data/store/v1/mget":
        return (await sup.mGet(data as any)) as unknown as T;
      case "/data/store/v1/mset":
        return (await sup.mSet(data as any)) as unknown as T;
      case "/data/store/v1/list":
        return (await sup.list(data as any)) as unknown as T;
      case "/data/store/v1/increase_counter":
        return (await sup.increaseCounter(data as any)) as unknown as T;
      case "/data/store/v1/count_ranked_list":
        return (await sup.countRankedList(data as any)) as unknown as T;
      default:
        throw new Error(`Unsupported endpoint ${endpoint} for Supabase adapter`);
    }
  }
...
export { DataType, Direction, SimpleSelector, MultiSelector };
